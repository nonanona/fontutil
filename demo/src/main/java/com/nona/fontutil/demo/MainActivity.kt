...
// Mostly copied from https://android.googlesource.com/platform/frameworks/support/+/androidx-master-dev/ui/integration-tests/demos/src/main/java/androidx/ui/demos/MainActivity.kt
open class MainActivity : ListActivity() {
    ...
    private fun getData(prefix: String?): List<Map<String, Any>> {
        ...
        val mainIntent = Intent(Intent.ACTION_MAIN, null).apply {
            addCategory("com.nona.fontutil.demos.SAMPLE_CODE")
